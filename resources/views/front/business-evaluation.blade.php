                ...
                <div class="w3breadcrumb-gids">
                    <div class="w3breadcrumb-left text-left">
                        <h2 class="inner-w3-title mt-sm-5 mt-4">
                           Business Evaluation </h2>

                    </div>
                    <div class="w3breadcrumb-right">
                        <ul class="breadcrumbs-custom-path">
                            <li><a href="{{route('home')}}">Home</a></li>
                            <li class="active"><span class="fas fa-angle-double-right mx-2"></span> business evaluation</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container py-lg-5">
            <div class="row">
                ...
                <div class=" col-lg-12 mt-lg-0 mt-sm-6 mt-6">
                  ...
                  {{--  @php echo get_service_intro('Business Evolution');   @endphp --}}
<br/></br>  
                    @foreach($flow as $step)
                    <h3 class="title-w3l mb-4">{{$step->heading}}</h3>
                    <p>{!!$step->content!!}</p>
                    @endforeach
                    </div>
                </div>
