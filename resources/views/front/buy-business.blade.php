                ...
                <div class="w3breadcrumb-gids">
                    ...
                    <div class="w3breadcrumb-right">
                        <ul class="breadcrumbs-custom-path">
                            ...
                            <li class="active"><span class="fas fa-angle-double-right mx-2"></span> Buy A Business</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container py-lg-5">
            <div class="row">
                ...
                <div class=" col-lg-12 mt-lg-0 mt-sm-6 mt-6">
                    ...
                    <!-- <h3 class="title-w3l mb-4">How we cater buying a business</h3> -->
                    @php echo get_service_intro('Buy A Business');   @endphp
                    ...
                    We’ve been in the business brokerage industry for over 20 years. Learn how we can help you with the process of buying your business from valuation to closing  </p> -->
                    <br><br><div class="accordion" id="accordionExample">
