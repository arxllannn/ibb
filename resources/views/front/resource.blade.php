@extends('front.app')
@section('title') Infinity Business Brokers | Resources @endsection
@section('content')
                ...
                <div class="w3breadcrumb-gids">
                    ...
                    <div class="w3breadcrumb-right">
                        <ul class="breadcrumbs-custom-path">
                            ...
                            <li class="active"><span class="fas fa-angle-double-right mx-2"></span> resources</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container py-lg-5">
            <div class="row">
                ...
                <div class=" col-lg-12 mt-lg-0 mt-sm-6 mt-6">
                    ...
                    @foreach($flow as $member)
            <div class="col-lg-12 mb-12">
                <div class="row">
                    <!-- Column 1: Team member image -->
                    <div class="col-md-3">
                        <img src="{{ $member->photo }}" alt="{{ $member->name }}" class="img-fluid img-resource">
                    </div>
                    <!-- Column 2: Team member details -->
                    <div class="col-md-9">
                        <h3>{{ $member->name }}</h3>
                        ...
                        <br>
                        <p class="text-justify">{{ $member->content }}</p>
                    </div>
                </div>
            </div>
            <hr>
