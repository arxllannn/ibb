...
@section('title') Edit Business Purchase Step @endsection
@section('content')        
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Edit Buy Business</h4>
                    <div class="ms-auto text-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('portal.dashboard')}}">Home</a></li>
                                <li class="breadcrumb-item">Buy Business</li>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="editForm" class="form" method="POST" data-route="{{ route('portal.business-purchase-flow.update', $flow->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                                <textarea class="form-control" id="summernote" name="step_content" placeholder="Enter Service Description" required>{{ old('step_content', $flow->content) }}</textarea>
                            </div>
                        </div>
