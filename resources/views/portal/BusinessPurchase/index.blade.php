...
@section('title') Business Purchase @endsection
@section('content')        
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Buy Business Steps</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('portal.dashboard')}}">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Buy Business Steps</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <!-- ============================================================== -->
                        <div class="card">
                            <div class="card-body">
                               ...
                               <a href="{{route('portal.business-purchase-flow.add')}}"> <button type="button" class="btn btn-primary btn-sm float-right">Add Step</button></a>
...
$(function () {
    $('#zero_config').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('portal.business-purchase-flow.list') }}",
        responsive: true,
        columns: [
            // { 
        ...
        order: [[0, 'asc']], // Adjust order to be based on step_name
    });
});
</script>
