...
@section('title') Business Evaluation @endsection
@section('content')        
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Business Evaluation</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('portal.dashboard')}}">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Business Evaluation</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <!-- ============================================================== -->
                        <div class="card">
                            <div class="card-body">
                               ...
                               <a href="{{route('portal.business-evaluation.add')}}"> <button type="button" class="btn btn-primary btn-sm float-right">Add</button></a>
...
$(function () {
    $('#zero_config').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('portal.business-evaluation.list') }}",
        responsive: true,
        columns: [
            // { 
        ...
        order: [[0, 'asc']], // Adjust order to be based on heading
    });
});
</script>
@endsection