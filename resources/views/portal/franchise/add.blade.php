...
@section('title') Add franchise  @endsection
@section('content')        
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Add franchise Content</h4>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="editForm" class="form" method="POST" data-route="{{ route('portal.franchise.store') }}" enctype="multipart/form-data">
