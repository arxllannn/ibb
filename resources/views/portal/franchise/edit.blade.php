...
@section('title') Edit franchise @endsection
@section('content')        
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="editForm" class="form" method="POST" data-route="{{ route('portal.franchise.update', $flow->id) }}" enctype="multipart/form-data">
