            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Services Intro</h4>
                ...
                <!-- ============================================================== -->
                        <div class="card">
                            <div class="card-body">
                               ...
                               <!-- <a href="{{route('portal.about.add')}}"> <button type="button" class="btn btn-primary btn-sm float-right">Add</button></a>
                                 -->
        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    ...
                    var truncatedText = words ? words.slice(0, 10).join(' ') : '';
