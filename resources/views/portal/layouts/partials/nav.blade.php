                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{route('portal.dashboard')}}">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img class="nav-logo" src="{{url('/theme')}}/assets/images/ibb.png" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            {{--<img src="{{url('/theme')}}/assets/images/logo-text.png" alt="homepage" class="light-logo" />--}}
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{url('/theme')}}/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31">
                            </a>
