...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Subscriber Broadcast</h4>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form class="form" class="form-horizontal" method="POST" data-route="{{ route('portal.subcriber.spread-broadcast') }}" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-1  control-label col-form-label required">Subject</label>
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="email_content" name="email_content" placeholder="Heading One" required>
                        </div>
                    </div>
