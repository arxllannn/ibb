...
@section('title') Add Business Sale Step @endsection
@section('content')
<div class="page-wrapper">
                ...
                <div class="ms-auto text-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Visas</li>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form class="form" class="form-horizontal" method="POST" data-route="{{ route('portal.visa.store') }}" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label class="col-sm-1  control-label col-form-label required">Step Name :</label>
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="step_name" name="heading" placeholder="Step -Name" required>
                        </div>
                    </div>
