                        ...
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Visas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <!-- ============================================================== -->
                        <div class="card">
                            <div class="card-body">
                               ...
                               <a href="{{route('portal.visa.add')}}"> <button type="button" class="btn btn-primary btn-sm float-right">Add</button></a>
...
$(function () {
    $('#zero_config').DataTable({
        ...
        order: [[0, 'asc']], // Adjust order to be based on the 'heading' column or any other column
    });
});
</script>
@endsection